        ...
        <div class="col-12 mt-5">
            <div class="section-title">
                <h4 class="m-0 text-uppercase font-weight-bold">
                    <?php echo lang('Blog.btnCategory'); ?> : <?= esc($judul_kategori->nama_kategori); ?>
                </h4>
            </div>
        </div>
        ...
        <?php if (!empty($artikel)) : ?>
            <?php foreach ($artikel as $row) : ?>
                ...
                <div class="col-lg-4 mb-4">
                    <a href="<?= base_url($lang . '/' . ($lang === 'en' ? 'article' : 'artikel') . 'detail/' . ($lang === 'en' ? $row->slug_en : $row->slug)) ?>" class="text-decoration-none artikel-link">
                        <div class="position-relative d-flex flex-column h-100 mb-3 artikel-card">
                            ...
                            <div class="bg-white border border-top-0 p-4 flex-grow-1">
                                ...
                                <a class="h4 d-block mb-3 text-secondary font-weight-bold" href="<?= base_url($lang . '/' . ($lang === 'en' ? 'article' : 'artikel') . '/detail/' . ($lang === 'en' ? $row->slug_en : $row->slug)) ?>">
