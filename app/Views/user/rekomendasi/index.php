...
<div class="form-wrapper">
  ...
  <form action="<?= base_url('user/rekomendasi/hasil') ?>" method="post">
    ...
    <div class="form-row">
      ...
      <input type="text" name="nama" id="nama" class="form-control" required placeholder="Masukkan nama lengkap Anda" style="flex: 1; padding: 8px 10px; border-radius: 8px; border: 1.5px solid #ccc; font-size: 0.85rem;">
    </div>
    ...
    <div class="form-row">
      ...
      <select name="jarak" id="jarak" required>
        ...
        <option value="0-15 km">0-15 km</option>
        <option value="16-31 km">16-31 km</option>
        <option value="32-47 km">32-47 km</option>
        <option value="48-63 km">48-63 km</option>
      </select>
    </div>
    ...
    <div class="form-row" style="align-items: flex-start;">
      ...
      <div class="checkbox-group">
        <?php 
          $fasilitasList = ['Parkir', 'Toilet', 'Musholla', 'Tempat singgah/penginapan', 'Kios/tempat makan', 'Wahana bermain', 'Tempat foto'];
    ...
    <div class="form-row">
      ...
      <select name="harga" id="harga" required>
        ...
        <option value="Rp0-10.000">Rp0-10.000</option>
        <option value="Rp11.000-20.000">Rp11.000-20.000</option>
        <option value="Rp21.000-30.000">Rp21.000-30.000</option>
    ...
    <button type="submit">Lihat Rekomendasi</button>
            ...
            <style>
              ...
              .form-wrapper {
                ...
                backdrop-filter: blur(2px); /* efek kaca buram */
              }
